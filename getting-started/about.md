...
Learn about the [architecture](architecture.md) first, get familiar with the [prequisites to installation](installation/)[ ](requirements/), then finally, step through how to [install the software](installation/) in your environment.
